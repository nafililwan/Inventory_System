...
export default function DeleteConfirmModal({ isOpen, onClose, onConfirm, store }: DeleteConfirmModalProps) {
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md">
              ...
              <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">Delete Store</h2>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="p-4 sm:p-6">
                <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
                  Are you sure you want to delete <span className="font-semibold">{store.store_name}</span>?
                </p>
                <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6">
                  This action cannot be undone. If this store has inventory or transactions, you may need to delete them first or use force delete.
                </p>
                ...
                <div className="flex items-start gap-2 sm:gap-3 mb-4 sm:mb-6">
                  ...
                  <label htmlFor="forceDelete" className="text-xs sm:text-sm text-gray-700 cursor-pointer">
                    Force delete (delete even if store has inventory or transactions)
                  </label>
                </div>
